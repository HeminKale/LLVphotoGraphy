    ...
    <div className="bg-[#100B21]">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div className="order-2 lg:order-1 animate-slide-up">
              ...
              <div className="space-y-4 text-[#D9D2E8] leading-relaxed">
                <p>
            ...
            <div className="order-1 lg:order-2 animate-fade-in">
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-[#1C1330] p-6 shadow-lg max-w-xs">
                  <p className="font-elegant text-lg text-[#F1EDFB] italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-16 border-t border-[#332950]">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#8F1ED2]/15 rounded-full flex items-center justify-center mx-auto mb-4">
                <Camera className="w-8 h-8 text-[#8F1ED2]" />
              </div>
              <h3 className="font-serif text-3xl text-[#F1EDFB] mb-2">250+</h3>
              <p className="text-[#A9A0C4]">Weddings Captured</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif text-3xl text-[#F1EDFB] mb-2">10+</h3>
              <p className="text-[#A9A0C4]">Years Experience</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif text-3xl text-[#F1EDFB] mb-2">15+</h3>
              <p className="text-[#A9A0C4]">Awards Won</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif text-3xl text-[#F1EDFB] mb-2">500+</h3>
              <p className="text-[#A9A0C4]">Happy Couples</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-[#1C1330]">
        <div className="container mx-auto max-w-4xl">
          <h2 className="font-elegant text-4xl md:text-5xl text-[#F1EDFB] text-center mb-12">
            My Approach
          </h2>

          <div className="space-y-12">
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0 w-12 h-12 bg-[#8F1ED2]/15 rounded-full flex items-center justify-center">
                <span className="font-serif text-[#8F1ED2] text-xl">1</span>
              </div>
              <div>
                <h3 className="font-serif text-2xl text-[#F1EDFB] mb-3">
                  Building Trust & Connection
                </h3>
                <p className="text-[#A9A0C4] leading-relaxed">
