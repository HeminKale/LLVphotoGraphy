...
export default function Testimonials() {
  ...
  return (
    <div className="bg-[#100B21] pt-32 pb-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          <Heart className="w-16 h-16 text-[#8F1ED2] mx-auto mb-6" />
          <h1 className="font-elegant text-5xl md:text-6xl lg:text-7xl text-[#F1EDFB] mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-24">
          <div className="text-center group bg-[#1C1330] p-8 rounded-sm shadow-lg hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="max-w-6xl mx-auto">
          <h2 className="font-elegant text-4xl md:text-5xl text-[#F1EDFB] text-center mb-16">
          ...
          {testimonials.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {testimonials.map((testimonial, index) => (
                <div
                  key={testimonial.id}
                  className="bg-[#1C1330] p-8 md:p-10 rounded-sm shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <Quote className="w-12 h-12 text-[#8F1ED2] mb-6" />

                  <blockquote className="mb-6">
                    <p className="font-elegant text-xl md:text-2xl text-[#A9A0C4] leading-relaxed italic">
                      "{testimonial.quote}"
                    </p>
                  </blockquote>

                  <footer className="border-t border-[#332950] pt-6">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full bg-[#8F1ED2] flex items-center justify-center">
                        <Heart className="w-6 h-6 text-white" />
                      </div>
                      <div>
                        <p className="text-[#F1EDFB] font-semibold text-lg">
            ...
            <div className="text-center py-20 bg-[#1C1330] rounded-sm shadow-lg">
              <Heart className="w-16 h-16 text-[#8F1ED2]/30 mx-auto mb-4" />
              <p className="text-[#A9A0C4] text-lg">
