    ...
    <div className="bg-white">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-6xl">
            ...
            {packages.map((pkg, index) => (
              ...
              >
                ...
                <div className={`p-8 ${pkg.featured ? 'pt-14' : ''}`}>
                  <h3 className="font-elegant text-3xl text-[#18181F] mb-2">
                    {pkg.name}
                  </h3>
                  <p className="text-[#5F5F72] text-sm mb-6 leading-relaxed">
                    {pkg.description}
                  </p>

                  <div className="mb-6 pb-6 border-b border-[#E5E3ED]">
                    <div className="flex items-baseline gap-2">
                      <span className="text-[#77778A] text-sm">Starting at</span>
                      <span className="font-serif text-4xl text-[#18181F]">
                        ${pkg.starting_price.toLocaleString()}
                      </span>
                    </div>
                    <p className="text-[#77778A] text-xs mt-1">
                  ...
                  <div className="space-y-3 mb-8">
                    {pkg.deliverables.map((item: string, i: number) => (
                      <div key={i} className="flex gap-3 items-start">
                        <div className="flex-shrink-0 w-5 h-5 bg-[#8F1ED2]/12 rounded-full flex items-center justify-center mt-0.5">
                          <Check className="w-3 h-3 text-[#8F1ED2]" />
                        </div>
                        <span className="text-[#33333F] text-sm">{item}</span>
                      </div>
                    ))}
                  </div>
          ...
          <div className="bg-white p-8 md:p-12 rounded-sm shadow-lg">
            <h3 className="font-elegant text-3xl text-[#18181F] mb-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <h4 className="font-semibold text-[#18181F] mb-1">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-[#5F5F72] text-lg leading-relaxed mb-8">
