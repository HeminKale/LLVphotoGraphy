          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            <div className="lg:col-span-2">
              <div className="sticky top-24">
                <h2 className="font-elegant text-4xl text-[#18181F] mb-6">
                  Get In Touch
                </h2>
                <p className="text-[#5F5F72] leading-relaxed mb-8">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4 items-start">
                    <div className="w-12 h-12 bg-[#8F1ED2]/12 rounded-full flex items-center justify-center flex-shrink-0">
                      <Mail className="w-5 h-5 text-[#8F1ED2]" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-[#18181F] mb-1">
                        Email
                      </h3>
                      <a
                        href="mailto:hello@lovelightvision.com"
                        className="text-[#5F5F72] hover:text-[#8F1ED2] transition-colors"
                      >
                ...
                <div className="mt-8 p-6 bg-white rounded-sm shadow-sm">
                  <h3 className="font-serif text-lg text-[#18181F] mb-3">
                    What to Expect
                  </h3>
                  <ul className="space-y-2 text-[#5F5F72] text-sm">
                ...
                <div className="mt-8">
                  <h3 className="font-serif text-lg text-[#18181F] mb-4">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    <label
                      htmlFor="brideName"
                      className="block text-[#33333F] font-medium mb-2"
                    >
                      Bride's Name *
                    </label>
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-[#E5E3ED] rounded-sm focus:outline-none focus:border-[#8F1ED2] transition-colors"
                    />
                  </div>
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-[#E5E3ED] rounded-sm focus:outline-none focus:border-[#8F1ED2] transition-colors resize-none"
                  />
                </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-[#5F5F72] text-lg max-w-2xl mx-auto">
